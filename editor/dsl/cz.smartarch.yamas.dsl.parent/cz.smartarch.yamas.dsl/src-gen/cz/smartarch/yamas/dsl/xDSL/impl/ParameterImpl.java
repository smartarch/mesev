 ...
 * </p>
 * <ul>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getDefaultValueString <em>Default Value String</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getDefaultValueInt <em>Default Value Int</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getRangeValue <em>Range Value</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getEnumValue <em>Enum Value</em>}</li>
 *   <li>{@link cz.smartarch.yamas.dsl.xDSL.impl.ParameterImpl#getValueConstraint <em>Value Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */

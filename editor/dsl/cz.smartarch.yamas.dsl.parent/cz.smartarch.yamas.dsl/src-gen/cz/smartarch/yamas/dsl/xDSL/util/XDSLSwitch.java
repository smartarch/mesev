...
public class XDSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RegularLinks regularLinks = (RegularLinks)theEObject;
        T result = caseRegularLinks(regularLinks);
        if (result == null) result = caseLink(regularLinks);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case XDSLPackage.EXPERIMENT_STEP:
      {
      ...
      case XDSLPackage.EXPERIMENT_TASK:
      {
        ...
        if (result == null) result = caseExperimentStep(experimentTask);
      ...
      case XDSLPackage.INTERACTION:
      {
        ...
        if (result == null) result = caseExperimentStep(interaction);
      ...
      case XDSLPackage.EXPERIMENT_SPACE:
      {
        ...
        if (result == null) result = caseExperimentStep(experimentSpace);
        if (result == null) result = caseExperimentNode(experimentSpace);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Regular Links</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Regular Links</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRegularLinks(RegularLinks object)
  {
    return null;
  }

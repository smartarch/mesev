 ...
 * </p>
 * <ul>
 *   <li>{@link com.mesev.dsl.xDSL.impl.TaskImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link com.mesev.dsl.xDSL.impl.TaskImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.mesev.dsl.xDSL.impl.TaskImpl#isConfigured <em>Configured</em>}</li>
 *   <li>{@link com.mesev.dsl.xDSL.impl.TaskImpl#getTaskConfiguration <em>Task Configuration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskImpl extends NodeImpl implements Task
{
  ...
  public NotificationChain basicSetTaskConfiguration(TaskConfigurationBody newTaskConfiguration, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDSLPackage.TASK__TASK_CONFIGURATION, oldTaskConfiguration, newTaskConfiguration);
  ...
  public void setTaskConfiguration(TaskConfigurationBody newTaskConfiguration)
  {
    if (newTaskConfiguration != taskConfiguration)
    {
      ...
      if (taskConfiguration != null)
        msgs = ((InternalEObject)taskConfiguration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDSLPackage.TASK__TASK_CONFIGURATION, null, msgs);
      if (newTaskConfiguration != null)
        msgs = ((InternalEObject)newTaskConfiguration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDSLPackage.TASK__TASK_CONFIGURATION, null, msgs);
      msgs = basicSetTaskConfiguration(newTaskConfiguration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDSLPackage.TASK__TASK_CONFIGURATION, newTaskConfiguration, newTaskConfiguration));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XDSLPackage.TASK__TASK_CONFIGURATION:

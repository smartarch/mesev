...
/**
 * This is the item provider adapter for a {@link com.mesev.model.workflow.Experiment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExperimentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Experiment_name_feature",
								"_UI_Experiment_type"),
						WorkflowPackage.Literals.EXPERIMENT__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.EXPERIMENT__STEPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.EXPERIMENT__STEPS,
				WorkflowFactory.eINSTANCE.createInteraction()));

		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.EXPERIMENT__STEPS,
				WorkflowFactory.eINSTANCE.createExperimentSpace()));

		newChildDescriptors.add(createChildParameter(WorkflowPackage.Literals.EXPERIMENT__STEPS,
				WorkflowFactory.eINSTANCE.createExperimentTask()));
	}
